...
final class Version20220806091731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_97DD1CB64AF38FD1 ON action_user_on_machine (deleted_at)');
        ...
        $this->addSql('CREATE TABLE clients (uuid UUID NOT NULL, name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, tenant_name VARCHAR(100) DEFAULT NULL, PRIMARY KEY(uuid))');
        ...
        $this->addSql('CREATE INDEX IDX_C82E744AF38FD1 ON clients (deleted_at)');
        $this->addSql('CREATE TABLE machines (uuid UUID NOT NULL, project_uuid UUID DEFAULT NULL, ip VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, domain VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, tenant_name VARCHAR(100) DEFAULT NULL, PRIMARY KEY(uuid))');
        ...
        $this->addSql('CREATE INDEX IDX_F1CE8DED4AF38FD1 ON machines (deleted_at)');
        $this->addSql('CREATE TABLE permissions (uuid UUID NOT NULL, user_uuid UUID DEFAULT NULL, create_by_uuid UUID DEFAULT NULL, user_permission_type VARCHAR(255) NOT NULL, related_entity VARCHAR(255) DEFAULT NULL, type_of_machine VARCHAR(255) DEFAULT NULL, related_entity_uuid UUID DEFAULT NULL, reverted BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, tenant_name VARCHAR(100) DEFAULT NULL, PRIMARY KEY(uuid))');
        ...
        $this->addSql('CREATE INDEX IDX_5C93B3A44AF38FD1 ON projects (deleted_at)');
        ...
        $this->addSql('CREATE TABLE users (uuid UUID NOT NULL, email VARCHAR(255) NOT NULL, firstName VARCHAR(255) NOT NULL, lastName VARCHAR(255) NOT NULL, pub_key VARCHAR(2048) DEFAULT NULL, password VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, tenant_name VARCHAR(100) DEFAULT NULL, PRIMARY KEY(uuid))');
        ...
        $this->addSql('ALTER TABLE permissions ADD CONSTRAINT FK_2DEDCC6FABFE1C6F FOREIGN KEY (user_uuid) REFERENCES users (uuid) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE permissions ADD CONSTRAINT FK_2DEDCC6FC5289E1C FOREIGN KEY (create_by_uuid) REFERENCES users (uuid) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
